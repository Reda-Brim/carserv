          ...
          <div class="card-body">
            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
              ...
              <div class="d-flex justify-content-end mb-4">
                <a href="{{ROUTE('admin.Nouveau_client')}}" class="btn btn-primary">Ajouter un nouveau client</a>
              </div>
              ...
              <tr>
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Prénom</th>
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="">Téléphone</th>
            ...
            <a href="{{route('admin.impression_clients')}}">Imprimer  </a>
