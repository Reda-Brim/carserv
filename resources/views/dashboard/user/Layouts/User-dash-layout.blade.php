    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="{{ Auth::guard('web')->user()->picture }}" class="img-circle elevation-2 admin_picture" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">{{Auth::guard('web')->user()->prenom }} {{Auth::guard('web')->user()->nom }}  </a>
        </div>
      </div>
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p> Listes des clients </p> <span class="right badge badge-danger">New</span> --}}
            {{-- </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
